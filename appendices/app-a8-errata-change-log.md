...
**Stray footer boilerplate inside an answer.** Two more instances of a stray `*Engineering Thermodynamics* by Olivier Cleynen` page-footer artifact were found spliced into running text: chapter 7, exercise 7.10's answer (PDF p.205); and chapter 8, between example 8.2's solution and example 8.3's problem statement (§8.3.3 p.219), and again in exercise 8.14's answer (PDF p.239). Neither instance split a word across a line break. All removed.
